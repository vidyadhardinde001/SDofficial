...
const FooterSection: React.FC = () => {
  return (
    <section className="relative bg-[#121825] text-white py-12 px-4 sm:px-6 lg:px-8 sm-mt-[10px]">
      {/* Top Section */}
      <div className="relative max-w-screen-xl mx-auto">
        <div className="bg-[#fb845d] rounded-[30px] p-8 md:p-12 text-center absolute inset-x-0 -top-2 transform -translate-y-1/2 mx-auto w-11/12 md:w-10/12 lg:w-8/12">
