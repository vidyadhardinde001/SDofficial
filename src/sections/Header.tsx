...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 backdrop-blur-lg z-50 bg-white">
      {/* Top Bar (Commented out in your original code) */}
      ...
      <div className="py-3">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* Call Us Button */}
            <button className="bg-[#575FF2] hover:bg-[#2E38F2] text-white px-4 py-2 rounded-full font-medium inline-flex align-items justify-center tracking-tight ml-auto hidden md:block">
              Call Us
            </button>
          </div>
        </div>
